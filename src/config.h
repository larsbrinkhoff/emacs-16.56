...
/* Include here a s- file that describes the system type you are using.
   Alternatives now defined include s-bsd4.2.h and s-bsd4.3.h for Berkeley
   systems, and s-uniplus5.2.h and s-uniplus.5.0.h for Unisoft-modified
   system V.
...
/* define XVSWINDOW if you want to use the X window system
   for the Vaxstation-100.  To make this work, you must change the makefile
   to pass -lX to ld.  */
...
/* subprocesses should be defined if you want to
 ...
 These do not work for USG systems yet.  */
